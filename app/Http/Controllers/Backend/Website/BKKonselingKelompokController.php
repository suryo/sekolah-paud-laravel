...
class BKKonselingKelompokController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pengguna.murid.bimbingan.konseling_kelompok.index',compact('data_bk'));
    }
    ...
    public function create()
    {
        ...
        $url = 'backend.pengguna.murid.bimbingan.konseling.kelompok.store';

        return view('backend.pengguna.murid.bimbingan.konseling_kelompok.form',compact('button','url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bimbingan.konseling.kelompok') 
    ...
    public function show(LayananBK $data_bk)
    {
        ...
        return view('backend.pengguna.murid.bimbingan.konseling_kelompok.show',compact('data_bk','daftar_siswa'));
    }
