...
class BKTanggapanController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pengguna.pengajar.bimbingan.ditanggapi.index',compact('data_bk'));
    }
    ...
    public function show(LayananBK $bk)
    {
        ...
        return view('backend.pengguna.pengajar.bimbingan.ditanggapi.show',compact('bk','daftar_siswa'));
    }
