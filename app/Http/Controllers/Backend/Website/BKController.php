...
class BKController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pengguna.pengajar.bimbingan.masuk.index', compact('data_bk'));
    }
    /**
    ...
    public function show(LayananBK $bk)
    {
        ...
        return view('backend.pengguna.pengajar.bimbingan.masuk.show',compact('bk','daftar_siswa'));
    }
    ...
    {   
        $url = 'bimbingan.masuk.update';

        $daftar_siswa = BKSiswa::where('bk_siswa_id',$bk->id)->get();

        $button = 'Kirim Tanggapan';

        return view('backend.pengguna.pengajar.bimbingan.masuk.form',compact('bk','url','button','daftar_siswa'));
    }
    ...
    public function update(Request $request, LayananBK $bk)
    {
        ...
        return redirect()->route('bimbingan.ditanggapi')
