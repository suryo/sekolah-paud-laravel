...
class BKPribadiController extends Controller 
{
    ...
    {   
        ...
        return view('backend.pengguna.murid.bimbingan.pribadi.index',compact('data_bk'));
    }
    ...
    {   
        ...
        return view('backend.pengguna.murid.bimbingan.pribadi.form',compact('button','url'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bimbingan.pribadi')
    ...
    {
        return view('backend.pengguna.murid.bimbingan.pribadi.show',compact('data_bk'));
    }
