...
class BKKelompokController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.pengguna.murid.bimbingan.kelompok.index',compact('data_bk'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.pengguna.murid.bimbingan.kelompok.form',compact('button','url','daftar_siswa'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('bimbingan.kelompok')
    ...
    public function show(LayananBK $data_bk)
    {
        ...
        return view('backend.pengguna.murid.bimbingan.kelompok.show',compact('data_bk','daftar_siswa'));
    }
